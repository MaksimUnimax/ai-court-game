...
## Addendum — Осмотр иллюстраций без подсказок

Движок должен позволять игроку внимательно рассматривать иллюстрации.

Крупный просмотр и масштабирование изображения являются инструментом наблюдения, а не механизмом подсказок.

Игрок может увеличить изображение, но игра не показывает, куда смотреть и какие детали важны.

## Addendum — ZIP как переносимый пакет дела

ZIP-архив является переносимым контейнером дела.

Сценарий остаётся источником логики, а visual_assets описывает, куда должны попасть изображения.

Распаковка архива не должна менять механику дела и не должна раскрывать hidden_purpose игроку.
