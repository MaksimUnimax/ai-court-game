...
## Addendum — Скрытая визуальная дедукция

Иллюстрации должны быть частью сценарной логики, но не должны превращаться в явные hotspot-подсказки.

Игрок должен видеть естественное изображение и самостоятельно замечать детали.

Движок не должен заставлять игрока нажимать на подписанную улику как на кнопку.

Сценарий должен знать, какие визуальные детали важны, но игроку они не должны быть раскрыты напрямую.

Правильный вывод должен рождаться из сопоставления диалогов, визуальных деталей и логики дела.

Для будущего формата сценария нужно предусмотреть связь иллюстраций с:

- участниками;
- местом события;
- предметом спора;
- важными визуальными деталями;
- скрытой правдой;
- финальным разбором.

## Addendum — visual_assets и распределение изображений

Сценарий может содержать необязательный раздел visual_assets.

Он описывает изображения дела и их привязку к участникам, сценам, объектам или делу в целом.

Движок должен использовать visual_assets для автоматической расстановки изображений.

Игрок не должен видеть скрытое назначение визуальных деталей.

Если изображение отсутствует, черновой MVP показывает placeholder.
